...
class UpcomingExpenseManager(models.QuerySet):
    ...
    def get_current_month(self):
        ...
        return self.filter(due_date__gte=first_of_month, due_date__lt=next_month)
