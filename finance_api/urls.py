...
urlpatterns = [
    ...
    path("finance/transactions/<str:tx_id>/", TransactionView.as_view(), name="transaction_detail_update_delete"), # Handles GET (single), PATCH, DELETE
    path("finance/appprofile/", AppProfileView.as_view(), name="appprofile"), # Handles GET (single)
    path("finance/appprofile/snapshot/", AppProfileView.as_view(), {"snapshot": True}, name="appprofile_snapshot"), # Handles GET snapshot
